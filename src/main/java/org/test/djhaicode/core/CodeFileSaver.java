...
public class CodeFileSaver {
    ...
    /**
     * 构建文件唯一目录路径：tmp/code_output/bizType_雪花ID
     * @param bizType 代码生成器类型，Hutool工具库实现雪花ID
     */
    private static String buildUniqueDir(String bizType) {
        String uniqueDirName = StrUtil.format("{}_{}", bizType, IdUtil.getSnowflakeNextIdStr());//两个拼接一起
